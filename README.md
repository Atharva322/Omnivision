...
The current branch packages the hardware-independent Track A and Track C implementation, plus the
Track D audio interface and Apple audio adapters, as `AccessLensTrackC`:
...
├── HCI/           Track D narrator, spoken copy, consent, earcons, pronunciation capture
...
- [`docs/TRACK_D.md`](docs/TRACK_D.md) — audio UX, consent, validation run sheet, and demo scripts
